        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeGB = table.Column<double>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryGameId = table.Column<int>(nullable: true),
                    LibraryUserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameGroups", x => new { x.GameId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_GameGroups_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameGroups_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameGroups_Library_LibraryUserId_LibraryGameId",
                        columns: x => new { x.LibraryUserId, x.LibraryGameId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameGroups_GroupId",
                table: "GameGroups",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GameGroups_LibraryUserId_LibraryGameId",
                table: "GameGroups",
                columns: new[] { "LibraryUserId", "LibraryGameId" });
