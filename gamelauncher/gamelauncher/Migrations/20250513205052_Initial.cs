    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGameGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGameGroups_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserGameGroupGames",
                columns: table => new
                {
                    UserGameGroupId = table.Column<int>(nullable: false),
                    GameId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGameGroupGames", x => new { x.UserGameGroupId, x.GameId });
                    table.ForeignKey(
                        name: "FK_UserGameGroupGames_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGameGroupGames_UserGameGroups_UserGameGroupId",
                        column: x => x.UserGameGroupId,
                        principalTable: "UserGameGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGameGroupGames_GameId",
                table: "UserGameGroupGames",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGameGroups_UserId",
                table: "UserGameGroups",
                column: "UserId");
